            ...
            <div class="row py-5">
                <div class="col-lg-4">
                    <div class="mx-auto features-icons-item mb-5 mb-lg-0 mb-lg-3">
                        ...
                        <h3 class="text-center">DOKTORA PROGRAMI</h3>
                        <div class="row text-left px-5">
                            <div class="col-12 text-start"><a class="text-decoration-none text-muted">➤Mimarlık Anabilim
                                    Dalı</a></div>
                            <div class="col-12 text-start"><a class="text-decoration-none text-muted">➤Endüstri Müh.</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="mx-auto features-icons-item mb-5 mb-lg-0 mb-lg-3">
                        ...
                        <h3 class="text-center">YÜKSEK LİSANS PROG.</h3>
                        <div class="row text-left px-5">
                            <div class="col-12 text-start"><a class="text-decoration-none text-muted">➤Bilgisayar
                                    Mühendisliği</a></div>
                            <div class="col-12 text-start"><a class="text-decoration-none text-muted">➤Elektronik Elektronik
                                    Müh.</a></div>
                        </div>
                    </div>
                </div>
