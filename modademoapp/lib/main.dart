...
class _AnaSayfaState extends State<AnaSayfa> with TickerProviderStateMixin {
        ...
        body: Padding(
          ...
          child: ListView(
            children: [
              ...
              ), //Üst Tarafta ki Profil bölme listesi
  ...
  Widget listeElemani(String imagePath, String imageLogoPath) {
    return Column(
      children: [
        Stack(
          children: [
            ...
            Positioned(
              //tabak mantığında altta kalmasını engeller üste atar koyduğumuz stacke göre sol sağ yukarı falan ayarlayabiliriz pozisyonu margin veriyoruz.
              top: 50,
              left: 50,
              child: Container(
                width: 25,
